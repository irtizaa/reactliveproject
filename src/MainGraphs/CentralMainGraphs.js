...
import CityWiseInfra from '../GraphsData/Central/CityWiseInfra.json'
import CityWiseLH from '../GraphsData/Central/CityWiseLHInfra.json'
import CoreWiseNetwork from '../GraphsData/Central/CoreWiseNetwork.json'
import NodeWiseCustomer from '../GraphsData/Central/NodeWiseCustomer.json'
import CentralRingCoreNetwork from '../GraphsData/Central/CentralRingCoreNetwork.json'
import CityWiseCustomer from '../GraphsData/Central/CityWiseCustomer.json'
import AerialBuried from '../GraphsData/Central/AerialBuried.json'
    ...
    <div className="container-fluid">
        <Row className="card-row">
            ...
            <CardSubtitle tag="h6" className="mb-2 text-muted" style={{  backgroundColor: "#240114"   }}>City Wise Infra Network in (Km)</CardSubtitle>
                 <CedarChart definition={CentralRingCoreNetwork}/>
                 </Card>
            </Col>
