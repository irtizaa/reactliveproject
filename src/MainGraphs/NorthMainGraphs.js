...
import CityWiseInfra from '../GraphsData/North/CityWiseInfra.json'
import CityWiseLH from '../GraphsData/North/CityWiseLHInfra.json'
import CoreWiseNetwork from '../GraphsData/North/CoreWiseNetwork.json'
import NodeWiseCustomer from '../GraphsData/North/NodeWiseCustomer.json'
import NorthRingWiseCustomer from '../GraphsData/North/NorthRingCoreNetwork.json'
import CityWiseCustomer from '../GraphsData/North/CityWiseCustomer.json'
    ...
    <div className="container-fluid">
        <Row className="card-row">
            ...
            <CardSubtitle tag="h6" className="mb-2 text-muted" style={{  backgroundColor: "#240114"   }}>City Wise Infra Network in (Km)</CardSubtitle>
                 <CedarChart definition={NorthRingWiseCustomer}/>
                 </Card>
            </Col>
