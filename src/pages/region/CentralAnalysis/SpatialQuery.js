...
export default class SpatialQuery extends React.Component{
    componentDidMount(){
        ...
        var Customerurl =
            "http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/1";
        ...
        function queryNodetotal() {
            ...
            queryNode.outFields = ["Node_Name", "Node_ID", "Ring_Name", "No_of_Links"];
        ...
        function displayDCstotal(results) {
            ...
            function queryCustomertotal() {
                ...
                queryCustomer.outFields = ["Customer_Name", "Node_Name", "Signup_ID", "Vendor"];
