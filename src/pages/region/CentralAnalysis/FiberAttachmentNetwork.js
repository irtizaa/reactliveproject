    ...
    loadModules(["esri/layers/FeatureLayer","esri/widgets/Search", "esri/tasks/support/Query", "esri/tasks/QueryTask",
     "esri/layers/GraphicsLayer", "esri/geometry/geometryEngine", "esri/Graphic", 'esri/widgets/Expand', "esri/geometry/Extent"
      ...
      .then(([FeatureLayer, Search, Query, QueryTask, GraphicsLayer, geometryEngine, Graphic, Expand, Extent]) => {  
        ...
        var fiberAttachurl =
          "http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/5";

        var nodeUrl = 
         "http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/0";
        ...
        function fortyeightcore() {   
          ...
          queryFAttachment.where = "Core_No= '48 Core' ";
          queryFAttachment.geometry = TownBuffer;
          queryFAttachment.outFields = ["FA_ID","Calculated_Length", "Core_No","Ring_Name", "City"];  
    ...
    return (
      <div>
        <div id="infoDiv5">
          ...
          <div id="buttons">
            <button id="fortyeight-Core"><i className="fas fa-columns"></i>48 Core</button> <br />
            <button id="ninghtysix-Core"><i className="fas fa-columns"></i>96 Core</button> <br />
           
          </div>

          <div id="buttons">
            <button id="twentyfour-Core"><i className="fas fa-columns"></i> 24 Core</button> <br />
