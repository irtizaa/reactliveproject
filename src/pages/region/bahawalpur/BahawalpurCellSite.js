...
export default class BahawalpurCellsite extends React.Component {
    ...
    componentDidMount() {
        ...
        loadModules(["esri/tasks/support/Query", "esri/tasks/QueryTask", "esri/Graphic", "esri/layers/GraphicsLayer"
            ...
            .then(([Query, QueryTask, Graphic, GraphicsLayer]) => {
                ...
                query1.where = "City = 'Bahawalpur' AND Stage = 'Pending'  AND Project_Year = '2019'"

                queryTask.executeForCount(query1).then(function (results) {
                    document.getElementById('B_PendingCellSite').innerHTML = results
                }); 
                ...
                let query2 = new Query({
                    ...
                    outFields: ["*"],
                    // where: "Stage = 'LitUp'"
                    where : "City = 'Bahawalpur' AND Stage = 'LitUp'  AND Project_Year = '2019'"  
                });
                queryTask.executeForCount(query2).then(function (results) {
                    document.getElementById('B_LitUpCellSite').innerHTML = results
                });
            })
    }
