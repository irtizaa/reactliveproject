...
export default class AggTotal extends React.Component {
            ...
            .then(([Query, QueryTask, Graphic, GraphicsLayer]) => {
               ...
               // let Total = document.getElementById('Tot')
                ...
                queryTask.executeForCount(query1).then(function (results) {
                    document.getElementById('T_PendingAgg').innerHTML = results
                }); 
                ...
                queryTask.executeForCount(query2).then(function (results) {
                    document.getElementById('T_LitUpAgg').innerHTML = results
                });
            })
    }
