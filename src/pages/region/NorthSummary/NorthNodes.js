    ...
    componentDidMount() {
        ...
        loadModules(["esri/tasks/support/Query", "esri/tasks/QueryTask", "esri/Graphic", "esri/layers/GraphicsLayer"
            ...
            .then(([Query, QueryTask, Graphic, GraphicsLayer]) => {
                ...
                let link = "http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/0"
                ...
                // let NorthNodes = document.getElementById('NorthNodes')
                // NorthNodes.addEventListener('click', function () {
                //     // view.goTo({
                ...
                queryTask.executeForCount(query1).then(function (results) {
                    document.getElementById('N_NodeCount').innerHTML = results
                });
            })
    }
