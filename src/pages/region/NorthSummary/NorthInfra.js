...
export default class MainpageTest extends React.Component{
    ...
    async  componentDidMount() {
        ...
        await Axios.get("http://103.31.82.102:8100/metro")
        .then(response => {
            this.setState({
                loading: false,
        ...
        await Axios.get("http://103.31.82.102:8100/metroAerial")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
        ...
        await Axios.get("http://103.31.82.102:8100/metroBuried")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
        ...
        await Axios.get("http://103.31.82.102:8100/lh")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
        ...
        await Axios.get("http://103.31.82.102:8100/lhAerial")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
        ...
        await Axios.get("http://103.31.82.102:8100/lhBuried")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
