       ...
       /*  let close = document.getElementById('close'); */  
        ...
        loadModules(["esri/tasks/support/Query", "esri/tasks/QueryTask", "esri/tasks/support/LengthsParameters",
            ...
            .then(([Query, QueryTask, LengthsParameters, FeatureLayer, MapImageLayer, Relationship, Expand]) => {
                ...
                let  TP_FTTT_Infra = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/GISInitiative2021/GISInitiative2021/MapServer/3", {
                    outFields: ["*"],
                    visible:true,
                    title: "TP FTTT Infra",
                    popupTemplate: 
                ...
                map.add(TP_FTTT_Infra);

                
                let  LH_Infra = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/GISInitiative2021/GISInitiative2021/MapServer/2", {
                    outFields: ["*"],
                    visible:true,
                    title: "LH Infra",
                    popupTemplate: 
                ...
                let  Metro_Infra = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/GISInitiative2021/GISInitiative2021/MapServer/1", {                    
                    title: 'Metro Fiber',
            ...
            map.add(Metro_Infra)  
                ...
                let  Ideas = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/GISInitiative2021/GISInitiative2021/MapServer/0", {                    
                    title: 'Ideas',
                // minScale: 150000,            //MN_MetroFiber_Network
