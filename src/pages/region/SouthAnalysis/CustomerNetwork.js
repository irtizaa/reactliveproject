...
export default class CustomerNetwork extends React.Component {
  ...
  componentDidMount() {
    ...
    loadModules(["esri/layers/FeatureLayer","esri/widgets/Search", "esri/tasks/support/Query", "esri/tasks/QueryTask",
     "esri/layers/GraphicsLayer","esri/symbols/PictureMarkerSymbol", "esri/geometry/geometryEngine", "esri/Graphic", 'esri/widgets/Expand', "esri/geometry/Extent"
    ])
      .then(([FeatureLayer, Search, Query, QueryTask, GraphicsLayer,PictureMarkerSymbol, geometryEngine, Graphic, Expand, Extent]) => {  
        ...
        var fiberurl =
          "http://103.31.82.102:6080/arcgis/rest/services/Projects/SouthRegion/MapServer/1"; 
        ...
        var fortyeightCore = document.getElementById("activeButtonID");
        var ninghtysixCore = document.getElementById("inactiveButtonID");
        ...
        view.ui.add("infoDiv8", "top-right");
        ...
        function fortyeightcore() {
          ...
          queryDC.where = "Region = 'South' ";
          queryDC.geometry = TownBuffer;
          queryDC.outFields = ["Signup_ID","Customer_Name","Node_Name", "No_of_Link", "Survey_Date", "Vendor","City"];

          queryDC.spatialRelationship = "intersects";


          queryFiber.executeForCount(queryDC).then(function (results) {
            result.innerHTML = "<b>Active Customers :</b>  " + results;
          });
        ...
        function nightysixcore() {
          ...
          queryFiber.executeForCount(queryDC).then(function (results) {
            result.innerHTML = "<b>InActive Customers :</b> " + results;
          });
        ...
        let clear = document.getElementById('clearSelection');
  ...
  render() {
    return (
      <div>
        <div id="infoDiv8">
          <b style = {{flex:1, textAlign: 'center'}}>Customers Analysis</b>
          <br/>
          ...
          <div id="buttons">
            <button id="activeButtonID"><i className="fas fa-columns"></i>Active</button> <br />
            <button id="inactiveButtonID"><i className="fas fa-columns"></i>InActive</button> <br />
          ...
          <button id="clearSelection">Clear Selection of Target Core</button>
           <br />
