...
*/
        ...
        // *********** ODB Query ***************
            let queryodb;
            let odburl = "http://103.31.82.102:6080/arcgis/rest/services/Projects/BahriaTown/MapServer/5";
            ...
            function getValues(response) {
                ...
                var values = features.map((feature, index) => {
                    return feature.attributes.FDT_ID;
                });
                return values;
            }
            ...
            function setODBExpression(newValue) {
                ...
                ODB.definitionExpression = "FDT_ID = '" + newValue + "'";

                 queryodb = new Query({
                    returnGeometry: true,
                    outFields: ["FDT_ID", "No_Of_Cores ", "Street_Name "],
                ...
                queryTask.executeForCount(queryodb).then(function (results) {
                    result.innerHTML = " Selected FDT : " + results;
        ...
        return (
            <div>
                <div id="infoDiv2">
                    ...
                    Select Desire FDT
                    <div> <strong>FDT = <span id="pop"></span></strong></div>
                    <select id="odb-type">
                        <option value = " ">...Unselect FDT...</option>
                    </select><br />
