...
export default class CentralCustomersSummary extends React.Component {
    ...
    componentDidMount() {
        ...
        loadModules(["esri/tasks/support/Query", "esri/tasks/QueryTask", "esri/Graphic", "esri/layers/GraphicsLayer"
            ...
            .then(([Query, QueryTask, Graphic, GraphicsLayer]) => {
                ...
                // centralNodes.addEventListener('click', function () {
                //     view.goTo({
                ...
                queryTask.executeForCount(query1).then(function (results) {
                    document.getElementById('C_onNetCustomerCount').innerHTML = results
                });
                ...
                queryTask.executeForCount(query2).then(function (results) {
                    document.getElementById('C_ThirdPartyCustomerCount').innerHTML = results
                });
                ...
                queryTask.executeForCount(query3).then(function (results) {
                    document.getElementById('C_T_CustomerCount').innerHTML = results
                });
