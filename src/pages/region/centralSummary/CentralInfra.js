...
export default class MainpageTest extends React.Component{
    ...
    async  componentDidMount() {
        ...
        await Axios.get("http://103.31.82.102:8300/metro")
        .then(response => {
            this.setState({
                loading: false,
            ...
            console.log(this.state.MetroInfratotal,"Central Metro")
        })
        ...
        await Axios.get("http://103.31.82.102:8300/metroAerial")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
        ...
        await Axios.get("http://103.31.82.102:8300/metroBuried")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
        ...
        await Axios.get("http://103.31.82.102:8300/lh")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
        ...
        await Axios.get("http://103.31.82.102:8300/lhAerial")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
        ...
        await Axios.get("http://103.31.82.102:8300/lhBuried")
        .then(response => {
            this.setState({
                loading: false,
               // customer: response.data.result,
