...
/* 
        ...
        console.log(geojson)
                ...
                const template = {
                    ...
                    content: "Magnitude {DC} {type} hit {place} on {time}",
                    fieldInfos: [
                        {
                            fieldName: "DC",
                            // format: {
...
*/
        ...
        // *********** ODB Query ***************
            let queryodb;
            let odburl = "http://172.30.30.234:6080/arcgis/rest/services/MN_South/MultiGIS/MapServer/14";
        ...
        return (
            <div>
                <div id="infoDiv">
                    ...
                    <select id="odb-type">
                        <option value = " ">...Unselect Nodes...</option>
                    </select><br />
