    ...
    componentDidMount() {
        ...
        loadModules(["esri/tasks/support/Query", "esri/tasks/QueryTask", "esri/Graphic", "esri/layers/GraphicsLayer"
            ...
            .then(([Query, QueryTask, Graphic, GraphicsLayer]) => {
                ...
                let link = "http://103.31.82.102:6080/arcgis/rest/services/Projects/BahriaTown/MapServer/1"
                ...
                let BTKSites = document.getElementById('BTKSites')
                BTKSites.addEventListener('click', function () {
                    // view.goTo({
                ...
                queryTask.executeForCount(query1).then(function (results) {
                    document.getElementById('BTK_SitesCount').innerHTML = results
                });
            })
    }
