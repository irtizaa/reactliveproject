        ...
        loadModules(["esri/layers/FeatureLayer", "esri/widgets/Editor"
            ...
            .then(([FeatureLayer, Editor]) => {
                ...
                let jointclosure = new FeatureLayer({
                    url: "http://172.16.6.107:6080/arcgis/rest/services/KarachiSDE/FeatureServer/2",
                    title: 'Joint Closure',
                ...
                let ODB = new FeatureLayer({
                    url: "http://172.16.6.107:6080/arcgis/rest/services/KarachiSDE/FeatureServer/1",
                    title: 'ODB/DC',
                ...
                let pop = new FeatureLayer({
                    url: "http://172.16.6.107:6080/arcgis/rest/services/KarachiSDE/FeatureServer/0",
                    title: 'POP',
                ...
                let HH = new FeatureLayer({
                    url: "http://172.16.6.107:6080/arcgis/rest/services/KarachiSDE/FeatureServer/3",
                    title: 'HH'
                ...
                let fat = new FeatureLayer({
                    url: "http://172.16.6.107:6080/arcgis/rest/services/KarachiSDE/FeatureServer/4",
                    title: "FAT",
                    popupTemplate: {
                        title: "FAT",
                        content: [{
                ...
                let fiber = new FeatureLayer({
                    url: "http://172.16.6.107:6080/arcgis/rest/services/KarachiSDE/FeatureServer/6",
                    title: 'Fiber',
