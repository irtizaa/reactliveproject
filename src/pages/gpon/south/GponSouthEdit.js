        ...
        loadModules(["esri/widgets/Search", "esri/widgets/Search/SearchViewModel",'esri/widgets/Expand', "esri/layers/FeatureLayer", "esri/widgets/Editor", "esri/widgets/LayerList",
            ...
            .then(([Search, SearchViewModel, Expand, FeatureLayer, Editor, LayerList, Legend, CoordinateConversion]) => {
                ...
                let source = [
                    {
                        layer: new FeatureLayer({
                            url: "http://172.16.6.163:6080/arcgis/rest/services/KarachiSDE/FeatureServer/5",
                        ...
                        layer: new FeatureLayer({
                            url: "http://172.16.6.163:6080/arcgis/rest/services/KarachiSDE/FeatureServer/1",
                            popupTemplate: { // autocasts as new popupTemplate()
                                title: "ODB/DC",
                                dockEnabled: true,
                                dockOptions: {
                ...
                let fiber = new FeatureLayer({
                    url: "http://172.16.6.163:6080/arcgis/rest/services/KarachiSDE/FeatureServer/6",
                    title: 'Fiber',
                ...
                let jointclosure = new FeatureLayer({
                    url: "http://172.16.6.163:6080/arcgis/rest/services/KarachiSDE/FeatureServer/2",
                    title: 'Joint Closure',
                ...
                let pop = new FeatureLayer({
                    url: "http://172.16.6.163:6080/arcgis/rest/services/KarachiSDE/FeatureServer/0",
                    title: 'POP',
                ...
                let HH = new FeatureLayer({
                    url: "http://172.16.6.163:6080/arcgis/rest/services/KarachiSDE/FeatureServer/3",
                    title: 'HH'
                ...
                let fat = new FeatureLayer({
                    url: "http://172.16.6.163:6080/arcgis/rest/services/KarachiSDE/FeatureServer/4",
                    title: "FAT",
                    popupTemplate: {
                        title: "FAT",
                        content: [{
