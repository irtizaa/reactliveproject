...
export default class CentralCustomerTable extends React.Component{
    constructor(props){
        super(props);
        this.state= {
            customer: [''],
    ...
    async componentDidMount(){
        // await Axios.get("http://172.30.30.237:5000/customers")
         await Axios.get("http://103.31.82.102:6001/customers")
            .then(response => {
                this.setState({
                    loading: false,
                        ...
                        <div className="col-12">
                            <div className="cards">
                                <div className="card-body">
                                    <h5 className="card-title">Central Customer Datatable</h5>
                                    <div className="table-responsive">
                                        ...
                                        <table id="example" className="table table-striped table-bordered">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><strong>Customer Names</strong></th>
