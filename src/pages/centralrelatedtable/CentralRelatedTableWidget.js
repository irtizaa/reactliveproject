...
import CentralRelatedTableLayers from './CentralRelatedTableLayers';


export default class CentralRelatedTableWidget extends React.Component {
    constructor(props){
        super(props);
        this.state = {
