...
import './centralrelatedtable.css'


export default class CentralRelatedTableLayers extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            id:'',                    
 ...
 */          
              ...
              /*   view.when(function () {
                ...
                let Customers = new FeatureLayer("http://103.31.82.102:6080/arcgis/rest/services/Projects/CentralRegion/MapServer/1", {
                    outFields: ["*"],
