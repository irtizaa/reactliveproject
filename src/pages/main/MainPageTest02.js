...
import { Collapse,Button, Card, CardHeader, CardBody, Badge, Col, Row,CardSubtitle} from 'reactstrap';
...
export default class MainpageTest2 extends React.Component{
...
{/* 
        <div className="row" style={{float:"left", padding:1}}>
             ...
             <b><div  className="column3" id="T_PendingAgg" style={{ color:"LightGray", fontSize:13}}></div></b>
                    ...
                    {/* Region Wise Infra */}
            <Col xs="12" sm="6" md="4">
                 <Card  style={{ height: '33.6vh',  backgroundColor: "#011424"   }}>
                {/* <CardSubtitle tag="h6" className="mb-2 text-muted" style={{backgroundColor: "#0f1012" ,color:"red", fontSize:17}}>City Wise Infra Network in (Km)</CardSubtitle> */}
                <CardSubtitle tag="h6" className="mb-2 text-muted" style={{backgroundColor: "#0f1012" , fontSize:17}}>  <h6 style={{color:"red", fontSize:17}}>Region Wise Infra</h6></CardSubtitle>
            ...
            <Col xs="12" sm="6" md="4">
                 <Card  style={{ height: '33.6vh',  backgroundColor: "#011424"   }}>
                <CardSubtitle tag="h6" className="mb-2 text-muted" style={{  backgroundColor: "#0f1012"   }}><h style={{color:"red", fontSize:17}}>City Wise Infra</h></CardSubtitle>
            ...
            <Col xs="12" sm="6" md="4">
              <Card  style={{ height: '33.6vh',  backgroundColor: "#011424"   }}>
                <CardSubtitle tag="h6" className="mb-2 text-muted" style={{  backgroundColor: "#0f1012"}}><h style={{color:"red", fontSize:17}}> Core Wise Infra </h></CardSubtitle>
            ...
            <Col xs="12" sm="6" md="4">
              <Card  style={{ height: '33.6vh',  backgroundColor: "#011424"   }}>
                <CardSubtitle tag="h6" className="mb-2 text-muted" style={{  backgroundColor: "#0f1012"   }}><h style={{color:"red", fontSize:17}}> Aerial & Buried Graph</h></CardSubtitle>
            ...
            <Col xs="12" sm="6" md="4">
               <Card  style={{ height: '33.6vh',  backgroundColor: "#011424"   }}>
                <CardSubtitle tag="h6" className="mb-2 text-muted" style={{  backgroundColor: "#0f1012"   }}><h style={{color:"red", fontSize:17}}>City Wise Customers </h></CardSubtitle>
