...
import NorthRelatedTableLayers from './NorthRelatedTableLayers';


export default class NorthRelatedTableWidget extends React.Component {
    constructor(props){
        super(props);
        this.state = {
    ...
    componentDidMount() {
        ...
        loadModules(["esri/widgets/Search", "esri/layers/FeatureLayer", "esri/layers/MapImageLayer", 'esri/widgets/Expand',
            ...
            },
            {
                                ...
                                fieldInfos: [
                                    {
                                        ...
                                        fieldName: "RainmakerGIS.GISADMIN.%v_CustomerIPDetailsForGIS.ProjectID",
                                        label: "Project ID",
                                        visible: true
                                    }, {
                                        ...
                                        fieldName: "RainmakerGIS.GISADMIN.%v_CustomerIPDetailsForGIS.Primary_SwitchName",
                                        label: "Switch Name",
                                        visible: true,
                                        format: {
                                            digitSeparator: true,
                                        ...
                                        fieldName: "RainmakerGIS.GISADMIN.%v_CustomerIPDetailsForGIS.SwitchIP",
                                        label: "Switch IP",
                                        visible: true,
                                        format: {
                                            digitSeparator: true,
                                        ...
                                        fieldName: "RainmakerGIS.GISADMIN.%v_CustomerIPDetailsForGIS.Primary_SwitchPort",
                                        label: "Switch Port",
                                        visible: true,
                                        format: {
                                            digitSeparator: true,
                                        ...
                                        fieldName: "RainmakerGIS.GISADMIN.%v_CustomerIPDetailsForGIS.ServiceUnit",
                                        label: "Service Unit",
                                        visible: true,
                                        format: {
                                            digitSeparator: true,
                                        ...
                                        fieldName: "RainmakerGIS.GISADMIN.%v_CustomerIPDetailsForGIS.Status",
                                        label: "Status",
                                        visible: true,
                                        format: {
                                            digitSeparator: true,
                                        ...
                                        fieldName: "MN_Central_Region.SDE.MN_Customers.City",
                                        label: "City",
                                        visible: true,
                                        format: {
                                            digitSeparator: true,
                ...
                searchFields: ["MN_Central_Region.SDE.MN_Customers.Signup_ID"],
                displayField: "MN_Central_Region.SDE.MN_Customers.Signup_ID",
                exactMatch: false,
                outFields: ["*"],
                name: "Customers",
                ...
                layer:   new FeatureLayer({			//Central MN_Rings
                    url: "http://103.31.82.102:6080/arcgis/rest/services/Projects/NorthRegion/MapServer/8",                        popupTemplate: { // autocasts as new popupTemplate()
                        title: "Rings",
                        content: [
                            {
                                type: "fields",
